---
description: Diagnose the Cursor plugin environment and surface residue that needs attention
argument-hint: ''
...
- If the report shows cursor-agent missing or unauthenticated, point the user at `/cursor:setup` for the guided install flow.
